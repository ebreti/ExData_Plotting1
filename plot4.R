...
plot(t2$Minutes, t2$Global_active_power, type="n", xlab="", 
     ylab="Global Active Power")
lines(t2$Minutes, t2$Global_active_power)

plot(t2$Minutes, t2$Sub_metering_1, type="n", xlab="", 
...
legend("topright", lwd = 1, col=c("darkgrey", "red", "blue"), bty="n", 
       legend=c("Sub_metering_1","Sub_metering_2","Sub_metering_3"))

plot(t2$Minutes, t2$Voltage, type="n", xlab="datetime", ylab="Voltage")
lines(t2$Minutes, t2$Voltage)

plot(t2$Minutes, t2$Global_reactive_power, type="n", 
     xlab="datetime", ylab="Global_reactive_power")
lines(t2$Minutes, t2$Global_reactive_power)
